...
function flexramp_scucmodel(NT::Int64, NB::Int64, NG::Int64, ND::Int64, NC::Int64, units::unit, loads::load, winds::wind, lines::transmissionline, config_param::config)
	...
	Plots.savefig(p5, "D:\\IEEE_Transactions Research\\2 ieee pes\\master - 1\\code\\highpenetration_DER\\fig\\flexramp_requirement.png")
	...
	open("D:\\IEEE_Transactions Research\\2 ieee pes\\master - 1\\code\\highpenetration_DER\\res\\flexramp_calculation_result.txt", "w") do io
		writedlm(io, [" "])
