...
# maximum(sum(loads.load_curve, dims = 1)[1, :])
...
Plots.plot(ben_p₀[1, :], label = "ben_p₀")
Plots.plot!(p₀[1, :], label = "p₀")

Plots.plot(ben_seq_sr⁺, label = "ben_seq_sr⁺")
Plots.plot!(seq_sr⁺, label = "seq_sr⁺")
Plots.plot!(re_seq_sr⁺, label = "re_seq_sr+")
...
Plots.plot(netload_curve_1[1, :])
Plots.plot(flexiramp_dw_requirement_1[1, :])
Plots.plot(flexiramp_up_requirement_1[1, :])
...
filepath = pwd()
Plots.savefig(p5, filepath * "\\benchmark\\fig\\flexiramp_compare.svg")
Plots.savefig(p1, filepath * "\\benchmark\\fig\\flexiramp_compare.pdf")

p6 = Plots.plot(p3, p4, size = (600, 280), layout = (1, 2))
Plots.savefig(p6, filepath * "\\benchmark\\fig\\flexiramp_compare_2.svg")
Plots.savefig(p6, filepath * "\\benchmark\\fig\\flexiramp_compare_2.pdf")
